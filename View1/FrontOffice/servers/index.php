...
<body>
                ...
                <section class="chat-area" aria-live="polite">
                    ...
                    <?php if ($isAIServer): ?>
                        ...
                        <div class="ai-suggestions">
                            <button type="button" class="ai-suggestion" onclick="setAIMessage('Hello! How are you?')">👋 Say Hello</button>
                            <button type="button" class="ai-suggestion" onclick="setAIMessage('What can you help me with?')">❓ What can you do?</button>
                            <button type="button" class="ai-suggestion" onclick="setAIMessage('Tell me something interesting')">💡 Tell me something</button>
                            <button type="button" class="ai-suggestion" onclick="setAIMessage('Help me with coding')">💻 Coding help</button>
                        </div>
                    <?php endif; ?>
    ...
    <script>
        ...
        function addMessageToUI(type, message) {
            ...
            article.innerHTML = `
                <div class="message-avatar">${type === 'ai' ? '🤖' : 'U'}</div>
                <div class="message-content">
                    <header class="message-header">
        ...
        function showTypingIndicator() {
            ...
            typing.innerHTML = `
                <div class="message-avatar" style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#9c27b0,#e91e63);display:flex;align-items:center;justify-content:center;">🤖</div>
