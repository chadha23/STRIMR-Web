...
class AIController {
    ...
    private function generateFallbackResponse(string $userMessage): string {
        ...
        if (preg_match('/\b(help|assist|support)\b/i', $message)) {
            return "I'm here to help! 🤖 You can ask me questions, chat about anything, or just say hi. What would you like to know?";
        }
        ...
        if (preg_match('/what can you do|what are you|who are you/i', $message)) {
            return "I'm an AI assistant powered by GPT-2! 🤖 I can chat with you, answer questions, and try to help with various topics. I'm still learning, so I might not always have the perfect answer, but I'll do my best!";
        }
