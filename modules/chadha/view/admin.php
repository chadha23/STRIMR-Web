        ...
        <main class="admin-main">
            ...
            <section id="dashboard-section" class="content-section active">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-icon users-icon">­ƒæÑ</div>
                    ...
                    <div class="stat-card">
                        <div class="stat-icon active-icon">­ƒƒó</div>
                        <div class="stat-content">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon messages-icon">­ƒÆî</div>
                        <div class="stat-content">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon servers-icon">­ƒÆ¼</div>
                        <div class="stat-content">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon streams-icon">­ƒô║</div>
                        <div class="stat-content">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon posts-icon">­ƒÉª</div>
                        <div class="stat-content">
            ...
            <section id="settings-section" class="content-section">
                ...
                <div class="settings-card">
                    ...
                    <div class="settings-item">
                        ...
                        <input type="text" class="settings-input" value="STRIMR-Web" />
                    </div>
                    <div class="settings-item">
    ...
    <div id="add-user-modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Add New User</h3>
                <button class="modal-close" onclick="closeModal('add-user-modal')">├ù</button>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Read the same data that login-script.js stores
    const token    = localStorage.getItem('userToken');
    const userId   = localStorage.getItem('userId');
    const username = localStorage.getItem('username');
    const isAdmin  = localStorage.getItem('isAdmin') === 'true';

    // If something is missing OR not admin ÔåÆ kick back to login
    ...
    // Show first letter of username in the admin avatar (optional)
    const adminAvatar = document.querySelector('.admin-avatar');
    if (adminAvatar && typeof username === 'string' && username.length > 0) {
