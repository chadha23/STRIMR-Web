                ...
                <div class="chat-area">
                    ...
                    <div class="input-area">
                        <div class="input-container">
                            ...
                            <button class="input-btn">Ô×ò</button>
                            ...
                            <!-- Attachment Button -->
                            <button class="input-btn">­ƒôÄ</button>
                            
                            <!-- Emoji Button -->
                            <button class="input-btn">­ƒÿè</button>
                    ...
                    <div class="compose-box">
                        ...
                        <div class="compose-actions">
                            ...
                            <div class="compose-icons">
                                <span class="compose-icon">­ƒû╝´©Å</span>
                                <span class="compose-icon">­ƒô╣</span>
                                <span class="compose-icon">­ƒÿè</span>
                            </div>
