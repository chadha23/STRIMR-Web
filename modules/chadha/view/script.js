...
// ============================================
const mockMessages = [
    { id: 1, username: 'User1', avatar: '­ƒæñ', content: 'Hey everyone! How are you doing?', time: '10:30 AM' },
    { id: 2, username: 'User2', avatar: '­ƒÄ«', content: 'Just finished a great gaming session!', time: '10:32 AM' },
    { id: 3, username: 'User3', avatar: '­ƒÆ╗', content: 'Working on some cool projects. Anyone want to collaborate?', time: '10:35 AM' },
    { id: 4, username: 'User1', avatar: '­ƒæñ', content: 'That sounds awesome! What are you building?', time: '10:37 AM' },
];
...
const mockPosts = [
    { id: 1, username: 'User1', handle: '@user1', avatar: '­ƒæñ', content: 'This is a tweet! Just sharing some thoughts about the latest tech trends and developments in the industry!', likes: 10, retweets: 5, replies: 2, liked: false },
    { id: 2, username: 'User2', handle: '@user2', avatar: '­ƒÄ«', content: 'Having a great time coding today! ­ƒÜÇ Working on some amazing features.', likes: 25, retweets: 12, replies: 3, liked: true },
    { id: 3, username: 'User3', handle: '@user3', avatar: '­ƒÆ╗', content: 'Check out this amazing project I just discovered! It\'s really inspiring.', likes: 8, retweets: 4, replies: 1, liked: false },
    { id: 4, username: 'User4', handle: '@user4', avatar: '­ƒÄÁ', content: 'Music production session was a success! Can\'t wait to share what I\'ve been working on.', likes: 15, retweets: 7, replies: 4, liked: false },
];
        ...
        streamCard.innerHTML = `
            <div class="stream-thumbnail">
                ${stream.isLive ? `
                    ...
                    <div class="viewer-count">­ƒæü´©Å ${stream.viewers.toLocaleString()}</div>
                ` : ''}
            </div>
