...
$limit = 4; // nombre dÔÇÖevents par page
...
<head>
    ...
    <style>
        ...
        /* Success state ÔÇö applied by JS by toggling class 'success' */
        .export-btn.success {
    ...
    <div class="admin-container">
        ...
        <main class="admin-main">
            ...
            <section id="dashboard-section" class="content-section active">
                <!-- Statistics Cards -->
                <!-- Statistics Cards - Syst├¿me ├ëv├®nements/R├®servations -->
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <div class="stat-label">├ëv├®nements Actifs</div>
                            ...
                            <div class="stat-change positive">├Ç venir</div>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-change positive">├ëv├®nements r├®serv├®s</div>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <div class="stat-label">├ëv├®nements Ce Mois</div>
...
function confirmExport() {
    if (confirm('Voulez-vous exporter un rapport PDF avec statistiques ?\n\nLe PDF inclura :\nÔ£ô Tous les ├®v├®nements\nÔ£ô Toutes les r├®servations\nÔ£ô Statistiques d├®taill├®es\nÔ£ô Date d\'exportation')) {
        exportPDF(event);
    }
}
...
function exportPDF(event) {
    ...
    const timer = setInterval(() => {
        seconds++;
        btn.innerHTML = `<i class="fas fa-spinner fa-spin"></i> G├®n├®ration... (${seconds}s)`;
    }, 1000);
    ...
    setTimeout(() => {
        clearInterval(timer);
        btn.innerHTML = '<i class="fas fa-check"></i> Termin├® !';
...
.page-btn.active {
                                        ...
                                        <td>
                                            ...
                                            <div class="row-actions">
                                                <button class="action-btn btn-edit" title="Edit"
                                                    ...
                                                    <span class="btn-icon">Ô£Å´©Å</span>
                                        ...
                                        <td>
                                            <div class="row-actions">
                                                ...
                                                <button class="action-btn btn-delete-reservation"
                                                    data-id="<?= $reservation['id_reservation'] ?>"
                                                    data-event="<?= htmlspecialchars($reservation['event_title']) ?>">
                                                    <span class="btn-icon">­ƒùæ´©Å</span>
                ...
                <div class="modal-message-container">
                    ...
                    <div class="modal-details" id="modalDetails" style="display: none;">
                        <div class="detail-item">
                            ...
                            <span id="detailEvent">├ëv├®nement</span>
                        </div>
                        <div class="detail-item">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
    ...
    <script>
        ...
        // Mettre ├á jour les fonctions pour g├®rer les ic├┤nes et couleurs
        ...
        // Mettre ├á jour les ├®couteurs d'├®v├®nements pour inclure les d├®tails
        ...
        // Mettre ├á jour la fonction de confirmation
        ...
        // Fermer en cliquant ├á l'ext├®rieur
    ...
    <section id="users-section" class="content-section">
        ...
        <!-- Pagination -->
        <div class="pagination">
            <button class="page-btn" onclick="changePage(-1)">ÔåÉ Previous</button>
            <span class="page-info">Page <span id="current-page">1</span> of <span id="total-pages">1</span></span>
            <button class="page-btn" onclick="changePage(1)">Next ÔåÆ</button>
        </div>
    </section>
    ...
    <div id="add-user-modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Add New User</h3>
                <button class="modal-close" onclick="closeModalById('add-user-modal')">├ù</button>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Ajouter un event listener ├á tous les boutons "delete"
            ...
            function deleteEvent(eventId, eventTitle = '') {
                ...
                <div style="text-align: center;">
                    <div style="font-size: 4rem; color: #e74c3c; margin-bottom: 1rem;">­ƒùæ´©Å</div>
                    <h3>Are you sure?</h3>
