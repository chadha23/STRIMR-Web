...
const mockMessages = [
    ...
    { id: 2, username: 'Luca Stone', avatar: 'LS', content: 'I just pushed a fresh update to the stream overlay Ô£¿', time: '09:07 AM' },
    { id: 3, username: 'Nova Chen', avatar: 'NC', content: 'Finishing the API docsÔÇöneed a quick review in #random.', time: '09:09 AM' },
...
const mockStreams = [
    ...
    { id: 3, streamer: 'LoopSmith', title: 'Layering ambience & beats ÔÇô chill set', game: 'Music Lab', viewers: 968, isLive: true },
    { id: 4, streamer: 'CloudAtlas', title: 'Ask me anything about scaling microservices', game: 'Tech Talks', viewers: 657, isLive: true },
];

const mockPosts = [
    { id: 1, username: 'Ava Rivers', handle: '@ava.codes', avatar: 'AR', content: 'Shipping a new feature preview tonight. Gradient generator now supports keyframed stops ­ƒöÑ', likes: 48, retweets: 12, replies: 6, liked: false },
    ...
    { id: 3, username: 'Nova Chen', handle: '@novadraws', avatar: 'NC', content: 'Sketching UI concepts for a cross-platform music sequencer. Dark mode feels ethereal Ô£¿', likes: 31, retweets: 8, replies: 4, liked: false },
...
const mockMarketplaceItems = [
    {
        ...
        price: 260,
        seller: 'Milo Hart',
        location: 'Vancouver ┬À Ships Worldwide',
        condition: 'Like New',
        category: 'tech',
    ...
    },
    {
        ...
        price: 420,
        seller: 'Jules Park',
        location: 'Los Angeles ┬À Local Pickup',
        condition: 'Excellent',
        category: 'creative',
    ...
    },
    {
        ...
        price: 750,
        seller: 'Nova Chen',
        location: 'Remote ┬À Ships North America',
        condition: 'Pristine',
        category: 'tech',
    ...
    },
    {
        ...
        price: 295,
        seller: 'Ava Rivers',
        location: 'Portland ┬À Local + Ship',
        condition: 'Good',
        category: 'lifestyle',
        ...
        card.innerHTML = `
            ...
            <div class="marketplace-card-body">
                ...
                <div class="marketplace-card-meta">
                    <span class="marketplace-card-seller">Seller ┬À ${item.seller}</span>
...
var mockMessageData = [
    ...
    { username: 'Luca Stone', avatar: 'LS', content: 'I just pushed a fresh update to the stream overlay Ô£¿', time: '09:07 AM' },
    { username: 'Nova Chen', avatar: 'NC', content: 'Finishing the API docsÔÇöneed a quick review in #random.', time: '09:09 AM' },
...
var mockStreamData = [
    ...
    { streamer: 'LoopSmith', title: 'Layering ambience & beats ÔÇô chill set', game: 'Music Lab', viewers: 968, isLive: true },
    { streamer: 'CloudAtlas', title: 'Ask me anything about scaling microservices', game: 'Tech Talks', viewers: 657, isLive: true }
];

var mockPostData = [
    { username: 'Ava Rivers', handle: '@ava.codes', avatar: 'AR', content: 'Shipping a new feature preview tonight. Gradient generator now supports keyframed stops ­ƒöÑ', likes: 48, retweets: 12, replies: 6, liked: false },
    ...
    { username: 'Nova Chen', handle: '@novadraws', avatar: 'NC', content: 'Sketching UI concepts for a cross-platform music sequencer. Dark mode feels ethereal Ô£¿', likes: 31, retweets: 8, replies: 4, liked: false },
...
function showPosts() {
    ...
    for (var i = 0; i < postList.length; i++) {
        ...
        html += '</div>';
        html += '<div class="post-more">Ôï»</div>';
        html += '</div>';
...
function showMarketplace() {
    ...
    for (var j = 0; j < itemsToShow.length; j++) {
        ...
        html += '<button class="marketplace-favorite' + savedClass + '" type="button" onclick="switchSavedMarketplaceItem(' + item.id + ')">ÔÖÑ</button>';
        html += '</div>';
        ...
        html += '<div class="marketplace-card-seller">Seller ┬À ' + item.seller + '</div>';
