...
function loadRecentActivity() {
    ...
    const activities = [
        { icon: '­ƒæñ', text: 'New user registered: alicew', time: '5 minutes ago' },
        { icon: '­ƒÆ¼', text: 'New message in General Server', time: '10 minutes ago' },
        { icon: '­ƒô║', text: 'Stream started: ProGamer123', time: '15 minutes ago' },
        { icon: '­ƒÉª', text: 'New post created by johndoe', time: '20 minutes ago' },
    ];
