...
function formatDate($dateString) {
    ...
    return $date->format('d M Y \├á H:i');
}
?>
...
<div class="nav-item" onclick="showPage('events', this)">
    ...
    <div class="nav-label">├ëv├®nements</div>
</div>
        </div>
    </nav>
    ...
    <div class="events-page">
        <div class="events-container">
            ...
            <div class="events-header">
                <h1 class="events-title">├ëv├®nements</h1>
                <p class="events-subtitle">D├®couvrez les ├®v├®nements ├á venir</p>
            </div>
...
function openReservationModal(eventId, eventTitle, eventDate, availablePlaces) {
    ...
    // Mettre ├á jour les informations de l'├®v├®nement
    document.getElementById('modalEventTitle').textContent = eventTitle;
    document.getElementById('modalEventDate').textContent = eventDate;
    
    // Mettre ├á jour l'ID de l'├®v├®nement dans le formulaire
...
// Fermer le modal en cliquant ├á l'ext├®rieur
...
<style>/* ============================================
   STYLES POUR LA PAGE ├ëV├ëNEMENTS
   ============================================ */
...
<script>// ============================================
// FONCTIONS POUR LES ├ëV├ëNEMENTS
// ============================================

function filterEvents(type, element) {
    // Mettre ├á jour les boutons actifs
